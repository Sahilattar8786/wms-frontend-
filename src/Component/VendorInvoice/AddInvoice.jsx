...
export default function AddInvoice() {
  ...
  const handleCreateInvoice = async () => {
    ...
    if (!selectedVendor || products.some((product) =>!product.product ||!product.qty ||!product.price)) {
    ...
    const response = await dispatch(createVendorInvoice({ vendorId: selectedVendor._id, totalAmount,products:productsToSend, InvoiceDate:invoiceDate,paymentType:paymentMethod })).unwrap();

    console.log('Invoice Created:', { selectedVendor, products, totalAmount, invoiceDate, paymentMethod });
  };
